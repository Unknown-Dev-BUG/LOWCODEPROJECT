...
describe("useDeleteMany Hook", () => {
  ...
  it("works correctly with `interval` and `onInterval` params", async () => {
    ...
    // advance 900ms: the overtime interval has fired 9 times while the
    // mutation (resolves at 1000ms) is still pending.
    await act(async () => {
    ...
    // advance past 1000ms: the mutation resolves, loading finishes and the
